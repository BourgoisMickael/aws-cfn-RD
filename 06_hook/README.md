# No typescript, not well documented, not stable enough for now

# MBO::Example::MyHook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `mbo-example-myhook.json`
2. Implement your resource handlers in `mbo_example_myhook/handlers.py`
